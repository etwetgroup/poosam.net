...
var Industry = function(){
	...
	var handleSupport = function(){
		var support = '<a href="javascript:void(0);" target="_blank" class="bt-buy-now theme-btn"><i class="ti-shopping-cart"></i><span>سبد خرید</span></a><a href="javascript:void(0);" target="_blank" class="bt-support-now theme-btn"><i class="ti-headphone-alt"></i><span>پشتیبانی</span></a><!-- Go to www.addthis.com/dashboard to customize your tools --><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"></script>';
