    ...
    ClassicEditor.create(document.querySelector('#editor'), {
        ...
        template: {
            definitions: [
                ...
                {
                    title: 'قالب شماره 1',
                    description: 'یکی در میان ( متن و تصویر )',
                ...
                {
                    title: 'قالب شماره 2',
                    description: 'تصاویر بالا و متن پایین تصاویر',
                    data: `<figure class="table">
                            <table>
                                <tbody>
                                    <tr>
                ...
                {
                    title: 'قالب شماره 3',
                    description: 'متن بالا و تصاویر پایین متن',
                    data: `<figure class="table">
                            <table>
                                <tbody>                                    
                                    <tr>
        ...
        cloudServices: {
            ...
            tokenUrl: 'https://113697.cke-cs.com/token/dev/85ZgXjRwRdqe6cprjBtpuzhvJNLbTfqOA7l9?limit=10',
        ...
        licenseKey: 'MmFNWUlnTCtDM1VKMUkwZkt2OUp0cEJ6ck1ESW94dmxtb2F0UmZHRHo4WCt5UVB2UWVUM1VUZXJKRnNZOHc9PS1NakF5TkRBNE1UUT0=',
        removePlugins: [
