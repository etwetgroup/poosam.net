    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tel', models.CharField(blank=True, max_length=255, null=True, verbose_name='شماره ثابت')),
                ('mobile', models.CharField(max_length=11, unique=True, verbose_name='شماره همراه')),
                ('address', models.CharField(blank=True, max_length=4000, null=True, verbose_name='آدرس')),
